...
> **Legacy application:** This PHP implementation is archived under `legacy/`
> as a migration reference. The active TypeScript application lives in
> [`../platform/`](../platform/). Do not add new product features here.
